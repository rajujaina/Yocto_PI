# Custom Raspberry Pi image with Sato GUI and hardware interface support
SUMMARY = "Custom Raspberry Pi image with Sato desktop, I2C, SPI, GPIO support"
DESCRIPTION = "A custom Yocto image for Raspberry Pi with Sato GUI and enabled hardware interfaces"
